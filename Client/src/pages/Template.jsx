  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const addFooter = (pageNum) => {
        ...
        // Add "Record generated by ipstechcommunity.kgkite.ac.in" at bottom right after the border
        pdf.setFontSize(7); // Smaller font size for the website label
        pdf.setFont('helvetica', 'italic');
        pdf.setTextColor(120, 120, 120); // Lighter gray color
        pdf.text("Record generated by ipstechcommunity.kgkite.ac.in", 
                pageWidth - borderMargin - 60, // Position it near the right border
          ...
          <div className="relative">
            ...
            <div className="p-6 flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center space-x-4 mb-4 md:mb-0">
                ...
                <div className="pl-2">
                  <h2 className="text-2xl font-bold text-blue-800 tracking-tight">Record Generator</h2>
                  <div className="flex items-center mt-1">
                    <div className="h-1.5 w-1.5 bg-blue-500 rounded-full mr-2"></div>
                    <p className="text-blue-600 text-sm font-medium">KGiSL Institute of Technology</p>
                  </div>
                </div>
              </div>
