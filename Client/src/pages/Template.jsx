  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const addFooter = (pageNum) => {
        ...
        // Add "Page No:" with the actual page number on right side of footer
        pdf.text(`Page No: ${pageNum}`, pageWidth - (borderMargin + 20), pageHeight - (borderMargin + 5));
        ...
        pdf.text("Record generated by ipstechcommunity.kgkite.ac.in", 
                pageWidth - borderMargin - 50, // Position it near the right border
